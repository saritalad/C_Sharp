...
namespace Collection_Example
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //  mylist.Add(x1); boxing takes place
            mylist.Add(y);
            mylist.Add("G Infotech");
            mylist.Add(300);
            mylist.Add(x = 10);
            mylist.AddRange(m);
            ...
            foreach (Car c in IndianCars)
                Console.WriteLine(c);
            //// Stack non generic Example LIFO
            ...
            //Console.WriteLine("Count of elements in mystack " + mystack.Count);
            ...
            h.Add("Mon", "Mondey");//key and value
            h.Add(1, "Friday");
            h.Add("key", null);
            h.Add("India", "Criket");
            IDictionaryEnumerator e = h.GetEnumerator();
            e.MoveNext();
            //Console.WriteLine("Hashtable Data "+e.Key + "\t" + e.Value);
            while (e.MoveNext())
                Console.WriteLine("Hashtable Data"+e.Key + "\t" + e.Value);
